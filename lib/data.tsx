...
export const calendarEvents = [
  {
    title: "Web tech",
    allDay: false,
    start: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 8, 0),
    end: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 8, 45),
  },
  {
    title: "UNIX",
    allDay: false,
    start: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 9, 0),
    end: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 9, 45),
  },
  {
    title: "Data Mining",
    allDay: false,
    start: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 10, 0),
    end: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 10, 45),
  },
  {
    title: "Softwere Enginering",
    allDay: false,
    start: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 11, 0),
    end: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 11, 45),
  },
  {
    title: "Break",
    allDay: false,
    start: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 12, 0),
    end: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 13, 0),
  },
  {
    title: "WEB Tec. Lab",
    allDay: false,
    start: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 13, 0),
    end: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 13, 45),
  },
  {
    title: "Unix Lab",
    allDay: false,
    start: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 14, 0),
    end: new Date(todayDate.getFullYear(), todayDate.getMonth(), todayDate.getDate(), 14, 45),
  },
