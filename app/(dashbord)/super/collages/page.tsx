  ...
  return (
    <div className='w-full min-h-screen'>
      ...
      <form className=' w-full flex items-center gap-5 justify-center' onSubmit={handleSubmit} >
        ...
        <button disabled={ collages.length === 0 } type="submit" className=" disabled:bg-gray-600 buttonbg h-14 w-32 text-lg rounded-full ">
      ...
      {selectedCollage && (
        <div className="mt-6">
            {loading && <p className=' text-center text-gray-400 '>Looking for {selectedCollage} collage...</p> }
          ...
          <div className='gap-3 px-2 flex justify-center  flex-wrap overflow-hidden  w-full  '>
            ...
            return (<div key={index} className='rounded-2xl p-3  inshadow border my-2 min-w-[340px] max-md:min-w-[130px] flex-1 bg-gradient-to-br from-[#386eb0d4] to-[#0a0b17]'> 
            ...
            return (<div key={index} className='rounded-2xl p-3 text-clip  inshadow border my-2 w- min-w-[340px] max-md:min-w-[130px] h-44 flex-1  bg-gradient-to-br from-[#386eb0d4] to-[#0a0b17]'>
            <h1 className=' text-2xl mb-4 font-semibold text-center '>UserName{item?.userName}  </h1>
            <p className=' text-'>Id:{item.id}</p>
            </div>)
            })}
                <Link href={'/super/admins'} className='rounded-2xl p-3  flex flex-col items-center justify-center h-44 inshadow border border-green-500 text-green-500 my-2 w-full  '>
                    <IoMdAdd />
                    <p>Add Admins</p>
                </Link>
